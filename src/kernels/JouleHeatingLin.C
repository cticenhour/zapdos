...
#include "JouleHeatingLin.h"

registerADMooseObject("ZapdosApp", JouleHeatingLin);

InputParameters
JouleHeatingLin::validParams()
{
...
JouleHeatingLin::JouleHeatingLin(const InputParameters & parameters)
  : ADKernel(parameters),
...
ADReal
JouleHeatingLin::computeQpResidual()
{
