...
#include "ReactionThirdOrderForShootMethod.h"

registerMooseObject("ZapdosApp", ReactionThirdOrderForShootMethod);

InputParameters
ReactionThirdOrderForShootMethod::validParams()
{
...
ReactionThirdOrderForShootMethod::ReactionThirdOrderForShootMethod(
...
ADReal
ReactionThirdOrderForShootMethod::computeQpResidual()
{
  Real power;
