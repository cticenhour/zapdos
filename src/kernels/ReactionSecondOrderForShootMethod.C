...
#include "ReactionSecondOrderForShootMethod.h"

registerMooseObject("ZapdosApp", ReactionSecondOrderForShootMethod);

InputParameters
ReactionSecondOrderForShootMethod::validParams()
{
...
ReactionSecondOrderForShootMethod::ReactionSecondOrderForShootMethod(
...
ADReal
ReactionSecondOrderForShootMethod::computeQpResidual()
{
  Real power;
