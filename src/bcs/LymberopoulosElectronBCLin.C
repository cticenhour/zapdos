...
#include "LymberopoulosElectronBCLin.h"

registerMooseObject("ZapdosApp", LymberopoulosElectronBCLin);

InputParameters
LymberopoulosElectronBCLin::validParams()
{
...
LymberopoulosElectronBCLin::LymberopoulosElectronBCLin(const InputParameters & parameters)
...
ADReal
LymberopoulosElectronBCLin::computeQpResidual()
{
  _ion_flux.zero();
  for (unsigned int i = 0; i < _num_ions; ++i)
  {
  ...
  return _test[_i][_qp] * _r_units *
         (_sign * _ks * _u[_qp] * _normals[_qp] * _normals[_qp] -
