...
#include "FVChargeSourceMoles_KV.h"

registerMooseObject("ZapdosApp", FVChargeSourceMoles_KV);

InputParameters
FVChargeSourceMoles_KV::validParams()
{
...
FVChargeSourceMoles_KV::FVChargeSourceMoles_KV(const InputParameters & parameters)
...
ADReal
FVChargeSourceMoles_KV::computeQpResidual()
{
  return -_e[_qp] * _sgn[_qp] * _N_A[_qp] * std::exp(_charged[_qp]) /
         _voltage_scaling;
}
