...
#include "FVReactionSecondOrderLog.h"

registerMooseObject("ZapdosApp", FVReactionSecondOrderLog);

InputParameters
FVReactionSecondOrderLog::validParams()
{
...
FVReactionSecondOrderLog::FVReactionSecondOrderLog(const InputParameters & parameters)
...
ADReal
FVReactionSecondOrderLog::computeQpResidual()
{
