...
#include "FVEEDFReaction.h"

registerMooseObject("ZapdosApp", FVEEDFReaction);

InputParameters
FVEEDFReaction::validParams()
{
...
FVEEDFReaction::FVEEDFReaction(const InputParameters & parameters)
...
ADReal
FVEEDFReaction::computeQpResidual()
{
  return -_reaction_coeff[_qp] * _em[_qp] * _target[_qp] * _coefficient;
}
