...
#include "FVJouleHeatingNonLog_Element.h"

registerMooseObject("ZapdosApp", FVJouleHeatingNonLog_Element);

InputParameters
FVJouleHeatingNonLog_Element::validParams()
{
...
FVJouleHeatingNonLog_Element::FVJouleHeatingNonLog_Element(const InputParameters & parameters)
...
ADReal
FVJouleHeatingNonLog_Element::computeQpResidual()
{
  return -_grad_potential[_qp] * _r_units * _voltage_scaling *
         (-_mu[_qp] * -_grad_potential[_qp] * _r_units * _em[_qp] -
