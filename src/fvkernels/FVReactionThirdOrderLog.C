...
#include "FVReactionThirdOrderLog.h"

registerMooseObject("ZapdosApp", FVReactionThirdOrderLog);

InputParameters
FVReactionThirdOrderLog::validParams()
{
...
FVReactionThirdOrderLog::FVReactionThirdOrderLog(const InputParameters & parameters)
...
ADReal
FVReactionThirdOrderLog::computeQpResidual()
{
