...
#include "FVReactionThirdOrderLogForShootMethod.h"

registerMooseObject("ZapdosApp", FVReactionThirdOrderLogForShootMethod);

InputParameters
FVReactionThirdOrderLogForShootMethod::validParams()
{
...
FVReactionThirdOrderLogForShootMethod::FVReactionThirdOrderLogForShootMethod(const InputParameters & parameters)
...
ADReal
FVReactionThirdOrderLogForShootMethod::computeQpResidual()
{
  Real power;
