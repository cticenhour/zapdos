...
#include "FVForceValue.h"
#include "Function.h"

registerMooseObject("MooseApp", FVForceValue);

InputParameters
FVForceValue::validParams()
{
...
FVForceValue::FVForceValue(const InputParameters & parameters)
...
ADReal
FVForceValue::computeQpResidual()
{
