...
[Materials]
  [./GasBasics]
    ...
    potential = potential
    mean_en = mean_en
    property_tables_file = Sakiyama_BOLSIG_RateCoefficients/electron_moments.txt
    position_units = ${dom0Scale}
  [../]
  [./gas_species_0]
  ...
  [./reaction_R0]
    ...
    property_file = 'Sakiyama_BOLSIG_RateCoefficients/reaction_He + em -> He + em.txt'
    reaction = 'He + em -> He + em'
    position_units = ${dom0Scale}
    file_location = ''
    em = em
  ...
  [./reaction_R2]
    ...
    mean_en = mean_en
    sampling_format = electron_energy
    property_file = 'Sakiyama_BOLSIG_RateCoefficients/reaction_He + em -> He+ + em + em.txt'
    reaction = 'He + em -> He+ + em + em'
    position_units = ${dom0Scale}
    file_location = ''
    em = em
  ...
  [./reaction_R9]
    ...
    mean_en = mean_en
    sampling_format = electron_energy
    property_file = 'Sakiyama_BOLSIG_RateCoefficients/reaction_He2+ + em -> He* + He.txt'
    reaction = 'He2+ + em -> He* + He'
    position_units = ${dom0Scale}
    file_location = ''
    em = em
