...
[Kernels]
  #Electron Equations (Same as in paper)
    ...
    [../]
    #[./em_SS]
    #  type = SourceStabilization
    #  variable = em
    #  variable_residual = emDeBug
    #  value = 20
    #  #type = BodyForce
    #  #variable = Ar+
    #  #value = 1e-4
    ...
    #  type = LogLimitStabilizationMoles
    #  variable = em
    #[../]
  ...
  #a different form but should be the same physics
    ...
    #  type = SourceStabilization
    #  variable = mean_en
    #  variable_residual = mean_enDeBug
    #  value = 1
    #[../]
    #Log Offset for excited atom density, not in paper since Zapdos uses an exponent form of density
...
[Executioner]
  ...
  #[./TimeStepper]
  #  type = RFSlowStart
  #  plasma_frequency_guess = 636396104.0
  #  drive_frequency = 13.56e16
  #  set_of_cycles = 150
  #[../]
  [./TimeStepper]
...
[Outputs]
  print_perf_log = true
  file_base = StabTest_WOSUPG_NewTS_WithMeta
  [./out]
    type = Exodus
  [../]
[]
